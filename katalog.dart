...
class Katalog extends Queue{
  ...
  void inputFilm(String judul, String genre, String tahun, String negara, String sutradara, String durasi){

    film = Film(judul, genre, tahun, negara, sutradara, durasi);

    katalog.writeAsStringSync("${film!.film['judul']},${film!.film['genre']},${film!.film['tahun']},${film!.film['negara']},${film!.film['sutradara']},${film!.film['durasi']}m\n", mode: FileMode.append);
  }
  ...
  void filterFilmByCountry(String asalnegara){
    ...
    if(check.isEmpty){
      print("| Negara tidak ada dalam list                                                                                         |");
    }
    print("+------+------------------------------------+----------------+-------+------------+--------------------------+--------+");
  ...
  void filterFilmByDirector(String sutradarafilm){
    ...
    if(check.isEmpty){
      print("| Sutradara tidak ada dalam list                                                                                      |");
    }
    print("+------+------------------------------------+----------------+-------+------------+--------------------------+--------+");
  ...
  void filerFilmByGenre(String genrefilm){
    ...
    if(check.isEmpty){
      print("| Genre tidak ada dalam list                                                                                          |");
    }
    print("+------+------------------------------------+----------------+-------+------------+--------------------------+--------+");
  ...
  void inputWatchlist(String film){
    ...
    for(int i = 0; i < this.elements.length; i++){
      ...
      print("| $n" + ( " " * (5 - no)) + "| ${this.elements[i]['judul']}" + ( " " * (35 - judul ))+"| ${this.elements[i]['genre']}" + (" " * (15 - genre)) + "| ${this.elements[i]['tahun']}  | ${this.elements[i]['negara']}" + (" " * (11 - negara)) + "| ${this.elements[i]['sutradara']}" + (" " * (25 - sutradara)) + "| ${this.elements[i]['durasi']}" + (" " * (7 - durasi)) + "|");
      n++;
    }
    print("+------+------------------------------------+----------------+-------+------------+--------------------------+--------+");
  }
